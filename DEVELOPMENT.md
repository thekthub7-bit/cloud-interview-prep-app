...
```bash
git remote add encore encore://cloud-interview-prep-app-5ip2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/cloud-interview-prep-app-5ip2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/cloud-interview-prep-app-5ip2/settings/integrations/github)
